...
Au passage, vérifiez que votre R est à jour en regardant la version avec la fonction du même nom : : `version`.
...
Ici, les options qui nous intéressent sont dans les templates : **"Ninja Presentation"** et **"Slides Datactivist"** (le thème Xaringan *parfum Datactivist* concocté par Joël) permettront de créer le fichier source de notre présentation :
...
Le fichier source est composé de plusieurs partie et écrit suivant une grammaire propre mais très simple.
